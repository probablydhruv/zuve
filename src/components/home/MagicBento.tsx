...
const cardData = [
  ...
  {
    color: 'linear-gradient(135deg, #533483 0%, #7209b7 50%, #3a0ca3 100%)',
    title: 'Instant 360 Video',
    description: 'Create high quality videos to share with your clients. All under 60 seconds',
    label: 'Video'
  },
  {
    color: 'linear-gradient(135deg, #f72585 0%, #7209b7 50%, #533483 100%)',
    title: 'Signature Style',
    description: 'Zuve AI Studio learns your brand\'s design language and remembers it',
    label: 'AI'
  },
  {
    color: 'linear-gradient(135deg, #4cc9f0 0%, #4361ee 50%, #3a0ca3 100%)',
    title: 'Motif Library',
    description: 'Find all your motifs and elements in one place',
    label: 'Library'
  },
  {
    color: 'linear-gradient(135deg, #0f3460 0%, #16213e 50%, #1a1a2e 100%)',
    title: 'Auto Job Cards',
    description: 'Creates a job card in one click for your production team',
    label: 'Production'
  },
  {
    color: 'linear-gradient(135deg, #4361ee 0%, #4cc9f0 50%, #7209b7 100%)',
    title: 'Stone Layout Assistant',
    description: 'Smart placement guidance',
    label: 'Assistant'
  },
  {
    color: 'linear-gradient(135deg, #3a0ca3 0%, #533483 50%, #f72585 100%)',
    title: 'Inspiration Gallery',
    description: 'Browse through 1000s of jewellery designs augmented by AI',
    label: 'Gallery'
  },
  {
    color: 'linear-gradient(135deg, #16213e 0%, #0f3460 50%, #4361ee 100%)',
    title: 'Intelligent Presentation',
    description: 'Export your designs as professional presentations instantly',
    label: 'Export'
  },
  {
    color: 'linear-gradient(135deg, #7209b7 0%, #f72585 50%, #4cc9f0 100%)',
...
const updateCardGlowProperties = (card: HTMLElement, mouseX: number, mouseY: number, glow: number | string, radius: number) => {
...
const GlobalSpotlight = ({
  ...
  useEffect(() => {
    ...
    const handleMouseLeave = () => {
      ...
      (gridRef.current?.querySelectorAll('.card') as NodeListOf<HTMLElement> | undefined)?.forEach(card => {
        card.style.setProperty('--glow-intensity', '0');
      });
